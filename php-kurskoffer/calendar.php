...
*/	
	...
	if ( isset($_POST['username']) && isset($_POST['password']) ){
		...
		$json1 = file_get_contents("http://localhost/moodle/login/token.php?username=".$_POST['username']."&password=".$_POST['password']."&service=my_service2");
		...
		if ($row == false){
			...
			$xml_obj = simplexml_load_file("http://localhost/moodle/webservice/rest/server.php?wstoken=".$token."&wsfunction=core_webservice_get_site_info");
		...
		echo "Anmeldung fehlgeschlagen! Bitte probieren Sie noch einmal.";
	}
